...
/**
 * Created by MariamNKinene on 05/07/2017.
 */

// Custom Adapter with ViewHolder supporting the use of the RecyclerView to provide news data
// to the list
...
public class NewsAdapter extends RecyclerView.Adapter<NewsAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            News newsFeed = mNews.get(position);

            // Get the Url from the current NewsItem
            mURL = newsFeed.getNewsURL();
    ...
    public void onBindViewHolder(NewsAdapter.ViewHolder viewHolder, int position) {
        ...
        newsTitleTextView.setText(newsItem.getHeadTitle());
